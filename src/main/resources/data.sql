...
(1,'코딩테스트 대비반','매주 수요일 저녁 7시 30분, 온라인 Zoom으로 진행하는 코딩테스트 대비 스터디입니다. 목표는 프로그래머스/백준 실버~골드 난이도 문제를 주 3문제 이상 풀고 매 회차 서로의 풀이를 리뷰하는 것입니다. 무단 결석이 2회 누적되면 스터디장과 상의 후 다음 기수부터 참여가 제한될 수 있으니, 부득이한 경우 최소 하루 전에는 미리 공지해주세요. 현재 정원이 마감되어 추가 모집은 받지 않습니다.',6,'ALGORITHM','CLOSED',false,DATE_SUB(@s1_1, INTERVAL 5 DAY),NOW()),
(2,'토익 900+ 스피드 스터디','토익 900점 이상을 목표로 매주 수요일 저녁 8시에 온라인으로 모이는 스터디입니다. 매 회차 LC/RC 모의고사 1회분을 풀고 오답노트를 공유하며, 단어 암기 테스트 과제를 2회 이상 미제출하면 스터디비 환급 대상에서 제외됩니다. 현재 정원이 다 차서 모집을 종료했습니다.',5,'ENGLISH','CLOSED',false,DATE_SUB(@s2_1, INTERVAL 4 DAY),NOW()),
(3,'정보처리기사 실기 벼락치기','정보처리기사 실기 시험을 함께 준비하는 스터디로, 매주 수요일 저녁 9시 온라인(디스코드)으로 진행합니다. 회차마다 기출문제 20문제를 풀고 오답 위주로 해설하는 방식이며, 출석률이 70% 미만이면 다음 회차부터 참여가 제한될 수 있습니다. 아직 정원에 여유가 있어 추가 모집 중입니다.',8,'CERTIFICATE','RECRUITING',false,DATE_SUB(@s3_1, INTERVAL 4 DAY),NOW()),
(4,'사이드 프로젝트: 스터디 매칭 앱','우리 동네 스터디 매칭 앱을 함께 만든 사이드 프로젝트 스터디였습니다. 매주 수요일 저녁 7시 온라인으로 모여 기획-디자인-개발 진행 상황을 공유했고, 무단 결석이 잦으면 다음 스프린트에서 역할을 조정하는 방식으로 운영했습니다. 6주간의 프로젝트를 마치고 최종 데모까지 마무리하여 현재는 종료된 스터디입니다.',5,'ETC','ENDED',false,DATE_SUB(@s4_1, INTERVAL 5 DAY),NOW()),
(5,'CS 전공지식 스터디','운영체제·네트워크·데이터베이스 등 CS 전공지식을 정리하는 스터디입니다. 매주 수요일 저녁 8시 30분 온라인으로 진행하며, 각자 정리한 내용을 발표하고 질문을 주고받는 방식입니다. 이제 막 시작한 스터디라 아직 자리가 남아있고, 무단 결석 2회 시 운영진과 별도 면담을 진행합니다.',7,'ETC','RECRUITING',false,DATE_SUB(@s5_1, INTERVAL 3 DAY),NOW()),
(6,'리트코드 위클리 챌린지','리트코드 문제를 매주 수요일 밤 9시 30분에 온라인으로 함께 풀어보는 위클리 챌린지 스터디입니다. 회차마다 Medium 난이도 이상 문제 2개를 풀이하고 코드 리뷰를 진행하며, 결석 2회 이상 시 다음 기수 참여 우선순위에서 제외됩니다. 현재 정원이 마감되어 모집을 종료했습니다.',6,'ALGORITHM','CLOSED',false,DATE_SUB(@s6_1, INTERVAL 6 DAY),NOW()),
(7,'매일 기록 챌린지: 회고 스터디','매일 하루를 짧게 회고하고 인증하는 스터디입니다. 정기 모임은 매주 화요일 저녁 9시 온라인으로 진행할 예정이며, 3일 이상 무단 미인증 시 스터디에서 제외될 수 있습니다. 이제 막 개설된 스터디로 함께할 팀원을 모집 중입니다.',10,'ETC','RECRUITING',false,DATE_SUB(NOW(), INTERVAL 13 DAY),NOW()),
(8,'오픽 IH 목표 스피킹 클럽','오픽 IH 등급 취득을 목표로 하는 스피킹 스터디입니다. 매주 목요일 저녁 8시 온라인 화상으로 모여 롤플레이와 모의시험을 진행할 예정입니다. 출석률 80% 미만이면 다음 기수부터 참여가 제한됩니다. 아직 스터디장 혼자라 팀원을 기다리고 있습니다.',6,'ENGLISH','RECRUITING',false,DATE_SUB(NOW(), INTERVAL 12 DAY),NOW()),
(9,'SQLD 3주 완성반','SQLD 자격증을 3주 안에 취득하는 것을 목표로 하는 벼락치기 스터디입니다. 매주 월/수요일 저녁 8시 온라인으로 모의고사를 풀고 오답을 리뷰합니다. 과제 미제출이 누적되면 스터디장이 개별 안내를 드립니다.',8,'CERTIFICATE','RECRUITING',false,DATE_SUB(NOW(), INTERVAL 11 DAY),NOW()),
(10,'취준생 포트폴리오 스터디','백엔드 취업 준비생을 위한 포트폴리오 완성 스터디입니다. 매주 금요일 저녁 7시 온라인으로 모여 서로의 프로젝트를 리뷰합니다. 무단 결석 2회 시 참여가 제한될 수 있습니다. 개설한 지 얼마 안 되어 팀원을 모집 중입니다.',5,'ETC','RECRUITING',false,DATE_SUB(NOW(), INTERVAL 10 DAY),NOW()),
(11,'자바 코딩테스트 입문반','자바로 코딩테스트 기초를 다지는 입문자용 스터디입니다. 매주 수요일 저녁 7시 온라인으로 진행하며, 매회 기초 문제 5개를 함께 풀이합니다. 결석 시 다음 회차 전까지 밀린 문제를 반드시 풀어와야 합니다.',6,'ALGORITHM','RECRUITING',false,DATE_SUB(NOW(), INTERVAL 9 DAY),NOW()),
(12,'토익스피킹 레벨7 목표반','토익스피킹 레벨7 취득을 목표로 하는 스터디입니다. 매주 화요일 저녁 9시 온라인 진행 예정이며, 출석 미달(70% 미만) 시 다음 기수 참여가 제한됩니다. 스터디장 1인 개설 단계로 팀원을 기다리는 중입니다.',6,'ENGLISH','RECRUITING',false,DATE_SUB(NOW(), INTERVAL 8 DAY),NOW()),
(13,'빅데이터분석기사 준비반','빅데이터분석기사 필기·실기를 함께 준비하는 스터디입니다. 매주 목요일 저녁 8시 온라인으로 모여 기출문제를 풀이합니다. 무단 결석 2회 누적 시 스터디장과 면담 후 계속 여부를 결정합니다.',7,'CERTIFICATE','RECRUITING',false,DATE_SUB(NOW(), INTERVAL 7 DAY),NOW()),
(14,'사이드 프로젝트 팀원모집(기획+디자인)','개발자 위주로 모인 사이드 프로젝트에 기획/디자인 팀원을 모집합니다. 매주 월요일 저녁 8시 온라인 미팅 예정이며, 2주 이상 연락두절 시 팀에서 제외될 수 있습니다.',6,'ETC','RECRUITING',false,DATE_SUB(NOW(), INTERVAL 6 DAY),NOW()),
(15,'파이썬 알고리즘 스터디(초급)','파이썬으로 알고리즘 기초를 다지는 초급자 스터디입니다. 매주 수요일 저녁 7시 온라인으로 모여 기초 문제를 함께 풉니다. 결석 2회 이상 시 스터디장과 상의가 필요합니다.',8,'ALGORITHM','RECRUITING',false,DATE_SUB(NOW(), INTERVAL 5 DAY),NOW()),
(16,'새벽 영어 회화 스터디','출근 전 새벽 6시 30분, 온라인으로 짧게 영어 회화를 연습하는 스터디입니다. 매주 월/수/금 진행 예정이며, 주 2회 이상 무단 결석 시 스터디에서 제외됩니다.',5,'ENGLISH','RECRUITING',false,DATE_SUB(NOW(), INTERVAL 4 DAY),NOW()),
(17,'컴활1급 실기 스터디','컴퓨터활용능력 1급 실기 시험을 준비하는 스터디입니다. 매주 토요일 오후 2시 온라인으로 실습 문제를 함께 풀이합니다. 과제 미제출 2회 시 개별 안내 드립니다.',6,'CERTIFICATE','RECRUITING',false,DATE_SUB(NOW(), INTERVAL 3 DAY),NOW()),
(18,'1인 개발 프로젝트 인증반','각자 진행 중인 1인 개발 프로젝트의 진행 상황을 매주 인증하는 스터디입니다. 매주 일요일 저녁 9시 온라인으로 모여 짧게 발표합니다. 2주 연속 미인증 시 스터디에서 제외됩니다.',10,'ETC','RECRUITING',false,DATE_SUB(NOW(), INTERVAL 2 DAY),NOW()),
(19,'코딩테스트 스터디(파이썬, 심화)','파이썬으로 코딩테스트 심화 문제를 푸는 스터디입니다. 매주 수요일 밤 10시 온라인으로 진행 예정이며, 무단 결석 2회 시 다음 기수 참여가 제한됩니다.',6,'ALGORITHM','RECRUITING',false,DATE_SUB(NOW(), INTERVAL 1 DAY),NOW()),
(20,'번역 스터디','원서 번역을 함께 연습하던 스터디였으나 참여 인원 부족으로 스터디장이 스터디를 삭제했습니다. (목록 미노출 테스트용 더미 데이터)',5,'ETC','RECRUITING',true,DATE_SUB(NOW(), INTERVAL 20 DAY),NOW());
